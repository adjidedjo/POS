class Users::RegistrationsController < Devise::RegistrationsController
  # before_filter :configure_sign_up_params, only: [:create] before_filter :configure_account_update_params, only: [:update]
...
#        sign_up(resource_name, resource)
  ...
  # GET /resource/edit def edit
  #   super
  # end

  # PUT /resource def update
  #   super
  # end

  # DELETE /resource def destroy
  #   super
  # end
